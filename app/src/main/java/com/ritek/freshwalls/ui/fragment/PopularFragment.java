...
public class PopularFragment extends Fragment {
    ...
    private void initView() {
         prefManager= new PrefManager(getContext().getApplicationContext());
        ...
        recycle_view_popular_fragment.setAdapter(wallpaperAdapter);
    ...
    private void loadNextWallpapers() {
        ...
        Call<List<Wallpaper>> call = service.wallpapersAll("views",page);
            ...
            public void onResponse(Call<List<Tag>> call, Response<List<Tag>> response) {
                ...
                if(response.isSuccessful()){
                    if (response.body().size()!=0){
                        ...
                        wallpaperList.add(new Wallpaper().setViewType(6));
                    }
                    wallpaperAdapter.notifyDataSetChanged();
                }
                loadWallpapers();
