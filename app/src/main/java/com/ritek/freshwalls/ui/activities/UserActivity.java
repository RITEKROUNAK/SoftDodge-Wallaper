...
import com.ritek.freshwalls.adapter.UserAdapter;
...
import com.ritek.freshwalls.ui.fragment.UserFragment;
            ...
            public void onResponse(Call<ApiResponse> call, Response<ApiResponse> response) {
                if (response.isSuccessful()){
                    ...
                    for (int i=0;i<response.body().getValues().size();i++){
                        ...
                        if (response.body().getValues().get(i).getName().equals("wallpapers")){
